...
namespace Astronauta
{
    internal class Historia
    {
        ...
        private void CrearHistoria()
        {
            ...
            Nodo nodo1 = new Nodo("Te acercas a los restos de la nave. " +
                "\nLa IA te indica un compartimento de emergencia intacto." +
            ...
            Nodo nodo1_1 = new Nodo("Encuentras suministros." +
            ...
            Nodo nodo1_2 = new Nodo("Decides ignorar la sugerencia de la IA y " +
                "\ncontinúas buscando en otros lugares de la nave. " +
                "Sin embargo, el calor y la falta de recursos te hacen desmayarte. " +
                "\nCuando despiertas, la IA ha tomado decisiones automáticas para preservar tu vida." +
                "\n1. Salir a explorar." +
                "\n2. Seguir en la nave.");
            ...
            Nodo nodo1_2_2 = new Nodo("Intentas reparar la nave con las piezas que has encontrado, " +
                "npero el daño es demasiado grande. Finalmente, la IA deja de funcionar y quedas solo.");
            ...
            Nodo nodo2_2 = new Nodo("Decides ignorar la cueva y seguir explorando la planicie. E" +
                "\nl terreno se vuelve más difícil y los recursos se agotan rápidamente. " +
            ...
            Nodo nodo2_2_1 = new Nodo("Te acercas a la estructura alienígena. La IA detecta " +
                "\nun mecanismo de entrada que requiere una clave de 4 dígitos.");
            ...
            nodo2_2_1.Accion = () =>
            {
                ...
                if (clave == "1234")
                {
                    Console.WriteLine("La clave es correcta. La puerta se abre y entras en la " +
                        "\nestructura donde encuentras una nave espacial intacta, la cual usas para escapar. " +
                        "\n¡Has sobrevivido!");
                ...
                else
                {
                    ...
                    Nodo finalBueno1 = new Nodo("Se desactiva el mecanismo de defensa. La puerta se abre y " +
                        "\nentras en la estructura donde encuentras una nave espacial intacta, la cual usas para escapar. " +
                        "\n¡Has sobrevivido!");
                    nodo2_2_1.OpcionIzquierda = finalBueno1;
                    nodo2_2_1.OpcionDerecha = finalMalo;
                }
            };
            ...
            Nodo nodo2_2_2 = new Nodo("Decides regresar a la nave para buscar más suministros, " +
                "\npero cuando llegas ya no está...");
            nodo2_2.OpcionDerecha = nodo2_2_2;

            // Finales posibles
            Nodo finalBueno = new Nodo("Has encontrado el artefacto alienígena correcto y " +
                "\n,logras contactar con una estación espacial cercana. Eres rescatado.");
            nodo1_1_1.OpcionIzquierda = finalBueno;
            nodo2_1_1.OpcionIzquierda = finalBueno;
            nodo1_1_2_1.OpcionIzquierda = finalBueno;

            Nodo finalAlternativo = new Nodo("El artefacto alienígena que has elegido es en realidad una trampa. " +
                "\nMueres a causa de la radiación que este transmite.");
            nodo2_1_1.OpcionDerecha = finalAlternativo;

            Nodo finalAlternativo2 = new Nodo("Encuentras un cristal alienígena que resulta ser una máquina que te permite teletransportarte. " +
                "\nLogras llegar a salvo a la tierra.");
